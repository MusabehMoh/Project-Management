 ...
 */
router.get("/", developerQuickActionsControllerV2.getQuickActions.bind(developerQuickActionsControllerV2));

/**
 * @route GET /api/developer-quick-actions/unassigned-tasks
 * @description Get unassigned tasks only
 */
router.get("/unassigned-tasks", developerQuickActionsControllerV2.getUnassignedTasks.bind(developerQuickActionsControllerV2));
 ...
 */
router.get("/almost-completed-tasks", developerQuickActionsControllerV2.getAlmostCompletedTasks.bind(developerQuickActionsControllerV2));

/**
 * @route GET /api/developer-quick-actions/available-developers
 * @description Get available developers
 */
router.get("/available-developers", developerQuickActionsControllerV2.getAvailableDevelopers.bind(developerQuickActionsControllerV2));
 ...
 */
router.post("/extend-task", developerQuickActionsControllerV2.extendTask.bind(developerQuickActionsControllerV2));
 ...
 */
router.post("/assign-developer", developerQuickActionsControllerV2.assignDeveloper.bind(developerQuickActionsControllerV2));
