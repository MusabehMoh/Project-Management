...
projectRequirementRoutes.get(
  "/assigned-projects",
  projectRequirementsController.getAssignedProjects.bind(projectRequirementsController),
);

// GET /api/project-requirements/projects/:projectId/requirements - Get requirements for a project
projectRequirementRoutes.get(
  "/projects/:projectId/requirements",
  projectRequirementsController.getProjectRequirements.bind(projectRequirementsController),
);
...
projectRequirementRoutes.post(
  "/projects/:projectId/requirements",
  projectRequirementsController.createRequirement.bind(projectRequirementsController),
);

// PUT /api/project-requirements/requirements/:requirementId - Update requirement
projectRequirementRoutes.put(
  "/requirements/:requirementId",
  projectRequirementsController.updateRequirement.bind(projectRequirementsController),
);
...
projectRequirementRoutes.post(
  ...
  projectRequirementsController.sendRequirement.bind(projectRequirementsController),
);

// DELETE /api/project-requirements/requirements/:requirementId - Delete requirement
projectRequirementRoutes.delete(
  "/requirements/:requirementId",
  projectRequirementsController.deleteRequirement.bind(projectRequirementsController),
);
