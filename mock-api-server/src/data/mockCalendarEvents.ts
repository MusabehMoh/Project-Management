...
export const mockCalendarEvents: CalendarEvent[] = [
  ...
  // Project milestones and deadlines (original data)
  {
    ...
    description:
      "Review and approve all functional requirements for Project Alpha before development phase",
  ...
  },
  {
    ...
    description:
      "Final deadline for submitting all requirements for Gamma project",
  ...
  },
  {
    ...
    description:
      "Workshop to define security requirements for all active projects",
  ...
  },
  {
    ...
    description:
      "Complete all alpha testing activities and compile test report",
  ...
  },
  {
    ...
    description:
      "Validate all requirements with stakeholders before final approval",
  ...
  },
  {
    ...
    description:
      "Submit monthly progress report on all requirements activities",
  ...
  },
  {
    ...
    description:
      "Final sign-off meeting with stakeholders for all project requirements",
...
export const getEventsByPriority = (
...
export const calculateCalendarStats = () => {
  ...
  const overdueEvents = mockCalendarEvents.filter(
    (e) => e.status === "overdue",
  ).length;
  ...
  const completedThisWeek = mockCalendarEvents.filter(
    (e) => e.status === "completed" && new Date(e.updatedAt) >= oneWeekAgo,
  ).length;

  const criticalDeadlines = mockCalendarEvents.filter(
    (e) =>
      e.priority === "critical" &&
  ...
  // Group by type
  const eventsByType = mockCalendarEvents.reduce(
    (acc, event) => {
  ...
  const allTypes: CalendarEvent["type"][] = [
    "project",
    "requirement",
    "meeting",
    "deadline",
  ...
  // Group by status
  const eventsByStatus = mockCalendarEvents.reduce(
    (acc, event) => {
  ...
  const allStatuses: CalendarEvent["status"][] = [
    "upcoming",
    "in-progress",
    "completed",
    "overdue",
