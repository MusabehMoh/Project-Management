...
{
    System.Threading.Tasks.Task<(IEnumerable<TaskEntity> Tasks, int TotalCount)> GetTasksAsync(int page, int limit, int? sprintId = null, int? projectId = null, int? assigneeId = null, int? statusId = null, int? priorityId = null, int? departmentId = null, string? search = null, int? typeId = null, DateTime? startDate = null, DateTime? endDate = null);
...
public interface IProjectRequirementRepository : IRepository<ProjectRequirement>
{
    ...
    System.Threading.Tasks.Task<(IEnumerable<ProjectRequirement> ProjectRequirements, int TotalCount)> GetProjectRequirementsByStatusesAsync(int page, int limit, int[] statuses, int? projectId = null, string? priority = null, string? search = null);
