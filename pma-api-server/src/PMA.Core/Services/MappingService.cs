...
public class MappingService : IMappingService
{
    ...
    /// </summary>
    public ProjectRequirement MapToProjectRequirement(CreateProjectRequirementDto dto, int createdBy, ProjectRequirement? existing = null)
    {
    ...
    public PMA.Core.Entities.Task MapToTask(CreateTaskDto createTaskDto)
    {
        return new PMA.Core.Entities.Task
        {
            ...
            RoleType= createTaskDto.DepartmentId==(int)DepartmentEnum .Development? "Developer": createTaskDto.DepartmentId== (int)DepartmentEnum.Qc ? "qc": createTaskDto.DepartmentId== (int)DepartmentEnum.Designer ? "Designer": createTaskDto.RoleType,
            CreatedAt = DateTime.Now,
            UpdatedAt = DateTime.Now,
