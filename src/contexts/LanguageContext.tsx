...
const translations = {
  en: {
    ...
    "common.info": "Info",
    "common.show": "Show",
    "common.itemsFound": "{count} items found",
    "common.loading": "Loading...",
    "common.uploading": "Uploading...",

    // AI Diagram Generator
    "ai.generateDiagram": "Generate Diagram",
    "ai.context": "Context",
    "ai.contextInfo": "Current Page Context",
    "ai.input": "Input",
    "ai.preview": "Preview",
    "ai.code": "Code",
    "ai.diagramType": "Diagram Type",
    "ai.diagramPrompt": "What diagram would you like to generate?",
    "ai.diagramPromptPlaceholder":
      "E.g., Create a flowchart for the user registration process",
    "ai.generate": "Generate",
    "ai.generating": "Generating...",
    "ai.noGeneratedDiagram": "Generate a diagram to see the preview",
    "ai.noGeneratedCode": "No code generated yet",
    ...
    "qcDashboard.needsReview": "Needs Quality Controller Assignment",
    ...
    "projects.status.notStarted": "Not Started",
    ...
    "projects.filterByProgress": "Filter by Progress",
    "projects.progress.notStarted": "Not Started (0%)",
    "projects.progress.inProgress": "In Progress (1-99%)",
    "projects.progress.completed": "Completed (100%)",
    ...
    "requirements.generateDiagram": "Generate AI Diagram",
    ...
    "requirements.noActionsAvailable": "No actions available for this status",
    ...
    "tasks.assignQC": "Assign Quality Controller",
    ...
    "departmentMembers.membersFound": "{count} members found",
    ...
    "timeline.noSprints": "No sprints available",
    ...
    "timeline.allProjects": "All Projects Overview",
    "timeline.projectsList": "Projects",
    "timeline.searchProjects": "Search projects",
    "timeline.filtersStatus": "Status",
    "timeline.filtersHealth": "Health",
    "timeline.filtersType": "Type",
    "timeline.filtersClear": "Clear filters",
    "timeline.accordion.overview": "Overview",
    "timeline.accordion.schedule": "Schedule",
    "timeline.accordion.requirements": "Requirements",
    "timeline.accordion.engagement": "Engagement",
    "timeline.stats.totalProjects": "Total Projects",
    "timeline.stats.onTrack": "On Track",
    "timeline.stats.atRisk": "At Risk",
    "timeline.stats.delayed": "Delayed",
    "timeline.details.projectManager": "Project Manager",
    "timeline.details.department": "Department",
    "timeline.details.lastUpdated": "Last Updated",
    "timeline.details.health": "Health",
    "timeline.details.priority": "Priority",
    "timeline.details.timeline": "Timeline",
    "timeline.details.nextMilestone": "Next Milestone",
    "timeline.details.requirements": "Requirements",
    "timeline.details.tasks": "Tasks",
    "timeline.details.budgetUsed": "Budget Used",
    "timeline.details.resources": "Resources",
    "timeline.details.team": "Team Members",
    "timeline.details.meetings": "Upcoming Meetings",
    "timeline.details.noMeetings": "No upcoming meetings scheduled",
    "timeline.details.noTeam": "No team members assigned",
    "timeline.timelineStatus": "Timeline Status",
    "timeline.noResults": "No projects match the current filters.",
    "timeline.viewDetails": "View details",
    "timeline.upcoming": "Upcoming",
    "timeline.completed": "Completed",
    "timeline.meetingAgenda": "Agenda",
    "timeline.meetingDate": "Date",
    "timeline.meetingHost": "Host",
    "timeline.progress": "Progress",
    "timeline.priority": "Priority",
    "timeline.health.onTrack": "On Track",
    "timeline.health.atRisk": "At Risk",
    "timeline.sortBy": "Sort by",
    "timeline.sortByName": "Name",
    "timeline.sortByProgress": "Progress",
    "timeline.sortByTimelines": "Timeline Count",
    "timeline.sortBySprints": "Sprint Count",
    "timeline.sortByTasks": "Task Count",
    "timeline.filterByProgress": "Filter by Progress",
    "timeline.lowProgress": "Low Progress",
    "timeline.mediumProgress": "Medium Progress",
    "timeline.highProgress": "High Progress",
    "timeline.activeFilters": "Active Filters",
    "timeline.search": "Search",
    "timeline.clearFilters": "Clear Filters",
    "timeline.noResultsFound": "No projects found",
    "timeline.tryDifferentFilters": "Try adjusting your search or filters",
    "timeline.health.critical": "Critical",
    "timeline.tabs.projects": "Projects",
    "timeline.tabs.insights": "Insights",
    "timeline.tabs.schedule": "Schedule",
    "timeline.loadingFailed": "Failed to load data",
    ...
    "timeline.expectedEndDate": "Expected End Date",
  ...
  ar: {
    ...
    "common.back": "العودة إلى النظرة العامة",
    "common.cancel": "إلغاء",
    ...
    "common.info": "معلومات",
    "common.show": "عرض",
    "common.itemsFound": "تم العثور على {count} موظف",
    ...
    // AI Diagram Generator
    "ai.generateDiagram": "إنشاء مخطط",
    "ai.context": "السياق",
    "ai.contextInfo": "سياق الصفحة الحالية",
    "ai.input": "الإدخال",
    "ai.preview": "معاينة",
    "ai.code": "الكود",
    "ai.diagramType": "نوع المخطط",
    "ai.diagramPrompt": "ما المخطط الذي تريد إنشاءه؟",
    "ai.diagramPromptPlaceholder": "مثال: أنشئ مخطط تدفق لعملية تسجيل المستخدم",
    "ai.generate": "إنشاء",
    "ai.generating": "جاري الإنشاء...",
    "ai.noGeneratedDiagram": "قم بإنشاء مخطط لعرض المعاينة",
    "ai.noGeneratedCode": "لم يتم إنشاء كود بعد",
    ...
    "teamDashboard.kanban.statusChangedFrom": "تم تغيير الحالة من",
    "teamDashboard.kanban.to": "إلى",
    "teamDashboard.kanban.viaKanban": "عبر لوحة كانبان",
    "teamDashboard.kanban.taskStatusUpdated": "تم تحديث حالة المهمة بنجاح",
    "teamDashboard.kanban.errorUpdatingStatus": "فشل تحديث حالة المهمة",
    "teamDashboard.kanban.errorLoadingTasks": "فشل تحميل المهام",
    ...
    "qcDashboard.needsReview": "بحاجة إلى تعيين مراقب جودة",
    ...
    "projects.status.notStarted": "لم يبدأ",
    ...
    "projects.filterByProgress": "تصفية حسب التقدم",
    "projects.progress.notStarted": "لم يبدأ (0%)",
    "projects.progress.inProgress": "قيد التنفيذ (1-99%)",
    "projects.progress.completed": "مكتمل (100%)",
    ...
    "requirements.generateDiagram": "إنشاء مخطط بالذكاء الاصطناعي",
    "requirements.aiPromptDescription":
    ...
    "requirements.noActionsAvailable": "لا توجد إجراءات متاحة لهذه الحالة",
    ...
    "departmentMembers.membersFound": "تم العثور على {count} عضو",
    "departmentMembers.noMembers": "لا يوجد أعضاء",
    "departmentMembers.tryDifferentSearch": "جرب كلمة بحث مختلفة",
    "departmentMembers.addFirstMember": "أضف أول عضو في القسم",
    ...
    "timeline.noSprints": "لا توجد سبرينتات متاحة",
    ...
    "timeline.allProjects": "نظرة عامة على جميع المشاريع",
    "timeline.projectsList": "المشاريع",
    "timeline.searchProjects": "ابحث في المشاريع",
    "timeline.filtersStatus": "الحالة",
    "timeline.filtersHealth": "الصحة",
    "timeline.filtersType": "النوع",
    "timeline.filtersClear": "مسح المرشحات",
    "timeline.accordion.overview": "نظرة عامة",
    "timeline.accordion.schedule": "الجدول الزمني",
    "timeline.accordion.requirements": "المتطلبات",
    "timeline.accordion.engagement": "التواصل",
    "timeline.stats.totalProjects": "إجمالي المشاريع",
    "timeline.stats.onTrack": "ضمن الجدول",
    "timeline.stats.atRisk": "مهدد بالخطر",
    "timeline.stats.delayed": "متأخر",
    "timeline.details.projectManager": "مدير المشروع",
    "timeline.details.department": "الإدارة",
    "timeline.details.lastUpdated": "آخر تحديث",
    "timeline.details.health": "الصحة",
    "timeline.details.priority": "الأولوية",
    "timeline.details.timeline": "المخطط الزمني",
    "timeline.details.nextMilestone": "المعلم التالي",
    "timeline.details.requirements": "المتطلبات",
    "timeline.details.tasks": "المهام",
    "timeline.details.budgetUsed": "الميزانية المستخدمة",
    "timeline.details.resources": "الموارد",
    "timeline.details.team": "أعضاء الفريق",
    "timeline.details.meetings": "الاجتماعات القادمة",
    "timeline.details.noMeetings": "لا توجد اجتماعات مجدولة",
    "timeline.details.noTeam": "لا يوجد أعضاء فريق مخصصون",
    "timeline.timelineStatus": "حالة المخطط الزمني",
    "timeline.noResults": "لا توجد مشاريع تطابق المرشحات الحالية.",
    "timeline.viewDetails": "عرض التفاصيل",
    "timeline.upcoming": "قادمة",
    "timeline.completed": "مكتملة",
    "timeline.meetingAgenda": "جدول الأعمال",
    "timeline.meetingDate": "التاريخ",
    "timeline.meetingHost": "المضيف",
    "timeline.progress": "التقدم",
    "timeline.priority": "الأولوية",
    "timeline.health.onTrack": "ضمن الجدول",
    "timeline.health.atRisk": "مهدد بالخطر",
    "timeline.health.critical": "حرج",
    "timeline.sortBy": "الترتيب حسب",
    "timeline.sortByName": "الاسم",
    "timeline.sortByProgress": "التقدم",
    "timeline.sortByTimelines": "عدد الجداول الزمنية",
    "timeline.sortBySprints": "عدد السبرينتات",
    "timeline.sortByTasks": "عدد المهام",
    "timeline.filterByProgress": "تصفية حسب التقدم",
    "timeline.lowProgress": "تقدم منخفض",
    "timeline.mediumProgress": "تقدم متوسط",
    "timeline.highProgress": "تقدم مرتفع",
    "timeline.activeFilters": "المرشحات النشطة",
    "timeline.search": "بحث",
    "timeline.clearFilters": "مسح المرشحات",
    "timeline.noResultsFound": "لم يتم العثور على مشاريع",
    "timeline.tryDifferentFilters": "حاول تعديل البحث أو المرشحات",
    "timeline.tabs.projects": "المشاريع",
    "timeline.tabs.insights": "التحليلات",
    "timeline.tabs.schedule": "الجدول",
    ...
    "timeline.expectedEndDate": "تاريخ الانتهاء المتوقع",
