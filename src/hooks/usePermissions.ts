...
export const usePermissions = () => {
  ...
  const permissionChecker = useMemo(() => ({
    ...
    hasAllActions: (actionNames: string[]) => hasAllActions(user, actionNames),
    ...
    can: {
      ...
      // Project management
      manageProjects: () => hasPermission(user, Permissions.PROJECT_MANAGEMENT),
      ...
      manageDepartments: () => hasPermission(user, Permissions.DEPARTMENT_MANAGEMENT),
      
      // Timeline management
      manageTimeline: () => hasPermission(user, Permissions.TIMELINE_MANAGEMENT),
